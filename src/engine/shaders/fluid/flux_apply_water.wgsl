// MoveWater final — water moves strictly by the fluxes: what a cell gives away
// is subtracted, what neighbours aimed at it is added. This is the pass the
// conservation gauge tests: bots off, evaporation zero, total water holds flat.
