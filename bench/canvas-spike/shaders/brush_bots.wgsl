...
@group(0) @binding(5) var wet0_out: texture_storage_2d<FMT_WATER, write>;
@group(0) @binding(6) var wet1_out: texture_storage_2d<FMT_PIG, write>;
@group(0) @binding(7) var wet2_out: texture_storage_2d<FMT_PIG, write>;
@group(0) @binding(8) var wet5_out: texture_storage_2d<FMT_WATER, write>;
